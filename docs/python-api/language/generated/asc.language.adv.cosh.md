...
### asc.language.adv.cosh(dst: [LocalTensor](../core.md#asc.language.core.LocalTensor), src: [LocalTensor](../core.md#asc.language.core.LocalTensor), count: int | None = None, temp_buffer: [LocalTensor](../core.md#asc.language.core.LocalTensor) | None = None, is_reuse_source: bool = False) → None
...
asc.adv.Cosh(dst, src, count=512, temp_buffer=shared_tmp_buffer)
```
