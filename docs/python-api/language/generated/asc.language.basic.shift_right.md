# asc.language.basic.shift_right

### asc.language.basic.shift_right(dst: [LocalTensor](../core.md#asc.language.core.LocalTensor), src: [LocalTensor](../core.md#asc.language.core.LocalTensor), scalar: int | float, count: int, is_set_mask: bool = True) → None

### asc.language.basic.shift_right(dst: [LocalTensor](../core.md#asc.language.core.LocalTensor), src: [LocalTensor](../core.md#asc.language.core.LocalTensor), scalar: int | float, mask: int, repeat_times: int, repeat_params: UnaryRepeatParams, is_set_mask: bool = True) → None
...
__aicore__ inline void ShiftRight(const LocalTensor<T>& dstLocal, const LocalTensor<T>& srcLocal,
...
- tensor高维切分计算样例-mask连续模式
  ...
  asc.shift_right(dst, src, scalar, mask=mask, repeat_times=4, repeat_params=params)
  ```
...
- tensor前n个数据计算样例
  ```python
  asc.shift_right(dst, src, scalar, count=512)
  ```
