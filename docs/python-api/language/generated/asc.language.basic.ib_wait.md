...
### asc.language.basic.ib_wait(gm_workspace: [GlobalTensor](../core.md#asc.language.core.GlobalTensor), ub_workspace: [LocalTensor](../core.md#asc.language.core.LocalTensor), block_idx: int, event_id: int, is_aiv_only: bool = True) → None
