...
### asc.language.basic.reduce_sum(dst: [LocalTensor](../core.md#asc.language.core.LocalTensor), src: [LocalTensor](../core.md#asc.language.core.LocalTensor), shared_tmp_buffer: [LocalTensor](../core.md#asc.language.core.LocalTensor), mask: int, repeat_time: int, src_rep_stride: int) → None

### asc.language.basic.reduce_sum(dst: [LocalTensor](../core.md#asc.language.core.LocalTensor), src: [LocalTensor](../core.md#asc.language.core.LocalTensor), shared_tmp_buffer: [LocalTensor](../core.md#asc.language.core.LocalTensor), mask: List[int], repeat_time: int, src_rep_stride: int) → None

### asc.language.basic.reduce_sum(dst: [LocalTensor](../core.md#asc.language.core.LocalTensor), src: [LocalTensor](../core.md#asc.language.core.LocalTensor), shared_tmp_buffer: [LocalTensor](../core.md#asc.language.core.LocalTensor), count: int) → None
