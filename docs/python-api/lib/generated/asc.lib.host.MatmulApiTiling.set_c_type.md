# asc.lib.host.MatmulApiTiling.set_c_type

#### MatmulApiTiling.set_c_type(self: libhost.MatmulApiTilingBase, pos: libhost.TPosition, type: libhost.CubeFormat, data_type: libhost.DataType) → int
