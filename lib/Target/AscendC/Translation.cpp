...
using PrintableOpTypes = std::tuple<
                ...
                // Arithmetic ops
                arith::ConstantOp, arith::MulIOp, arith::DivSIOp, arith::RemSIOp, arith::AddIOp, arith::IndexCastOp,
                arith::CmpIOp, arith::CmpFOp, arith::SubIOp, arith::CeilDivSIOp, arith::SelectOp, arith::AndIOp,
                arith::ShLIOp, arith::ShRSIOp, arith::MaximumFOp, arith::MaxNumFOp, arith::AddFOp, arith::MinimumFOp,
                arith::MinNumFOp, arith::DivFOp, arith::MinSIOp, arith::MaxSIOp, arith::MulFOp, arith::SubFOp,
                arith::ExtUIOp, arith::ExtSIOp, arith::ExtFOp, arith::TruncIOp, arith::TruncFOp, arith::FPToSIOp,
                arith::FPToUIOp, arith::SIToFPOp, arith::UIToFPOp, arith::BitcastOp, arith::ShRUIOp, arith::OrIOp,
                arith::XOrIOp, arith::DivUIOp, arith::MulUIExtendedOp,
                // Math ops
                math::AbsFOp, math::CopySignOp, math::SqrtOp, math::Atan2Op, math::ExpOp, math::LogOp, math::Log2Op,
                math::ErfOp, math::CosOp, math::SinOp, math::CeilOp, math::FloorOp, math::RsqrtOp, math::Exp2Op,
                math::FmaOp, math::RoundOp,
                // EmitAsc operations
                emitasc::CallOpaqueOp, emitasc::DeclarePyStructOp, emitasc::DereferenceOp, emitasc::MemberOp,
                emitasc::MemberPtrOp, emitasc::MemberRefOp, emitasc::PtrOffsetOp, emitasc::ReinterpretCastOp,
                emitasc::SetMemberOp, emitasc::VariableOp, emitasc::VerbatimOp, emitasc::CopyStructOp,
                ...
                // Matmul operations
                ascendc::MatmulInitOp, ascendc::MatmulEndOp, 
                ascendc::MatmulGetMatmulApiTilingOp, ascendc::RegistMatmulObjOp,
                // Normalization 
                ascendc::RmsNormOp, 
                // Quantization
                ascendc::QuantOp, 
                ...
                ascendc::TransposeOp, ascendc::TransposeExtOp,
                ascendc::TransDataTo5HDTensorListOp, ascendc::TransDataTo5HDUintListOp, ascendc::TransDataTo5HDOp,
                // Data copy operations
                ascendc::CopyL0Op,ascendc::CopyL1Op,
                ascendc::DataCopyL0Op, ascendc::DataCopyL2Op,
                ascendc::DataCopyNd2NzOp,  ascendc::DataCopyNz2NdOp, ascendc::DataCopySliceOp,
                ascendc::DataCopyCO12DstOp,
                // Dump tensor operations
                ascendc::PrintfOp, 
                // Other operations
                ascendc::ConstructOp, ascendc::AscendIsAICOp, ascendc::AscendIsAIVOp, LLVM::UndefOp, 
                ascendc::FftsCrossCoreSyncOp, ascendc::SetFftsBaseAddrOp, ascendc::PopStackBufferOp, 
                // Scalar operations
                ...
                // BinaryL0Op
                ascendc::AddL0Op, ascendc::AddDeqReluL0Op, ascendc::AddReluL0Op, ascendc::AddReluCastL0Op,
                ascendc::AndL0Op, ascendc::DivL0Op, ascendc::FusedMulAddL0Op, ascendc::FusedMulAddReluL0Op,
                ascendc::MaxL0Op, ascendc::MinL0Op, ascendc::MulL0Op, ascendc::MulAddDstL0Op, ascendc::MulCastL0Op,
                ascendc::OrL0Op, ascendc::SubL0Op, ascendc::SubReluL0Op, ascendc::SubReluCastL0Op,
                // BinaryL1Op
                ascendc::AddL1Op, ascendc::AddDeqReluL1Op, ascendc::AddReluL1Op, ascendc::AddReluCastL1Op,
                ascendc::AndL1Op, ascendc::DivL1Op, ascendc::FusedMulAddL1Op, ascendc::FusedMulAddReluL1Op,
                ascendc::MaxL1Op, ascendc::MinL1Op, ascendc::MulL1Op, ascendc::MulAddDstL1Op, ascendc::MulCastL1Op,
                ascendc::OrL1Op, ascendc::SubL1Op, ascendc::SubReluL1Op, ascendc::SubReluCastL1Op,
                // BinaryL2Op
                ascendc::AddL2Op, ascendc::AddDeqReluL2Op, ascendc::AddReluL2Op, ascendc::AddReluCastL2Op,
                ascendc::AndL2Op, ascendc::DivL2Op, ascendc::FusedAbsSubL2Op, ascendc::FusedExpSubL2Op,
                ascendc::FusedMulAddL2Op, ascendc::FusedMulAddReluL2Op, ascendc::MaxL2Op, ascendc::MinL2Op,
                ascendc::MulL2Op, ascendc::MulAddDstL2Op, ascendc::MulCastL2Op, ascendc::OrL2Op, ascendc::PreluL2Op,
                ascendc::SubL2Op, ascendc::SubReluL2Op, ascendc::SubReluCastL2Op,
                // BinaryL3Op
                ...
                // UnaryL0Op
                ascendc::AbsL0Op, ascendc::ExpL0Op, ascendc::LnL0Op, ascendc::NotL0Op, ascendc::ReciprocalL0Op,
                ascendc::ReluL0Op, ascendc::RsqrtL0Op, ascendc::SqrtL0Op,
                // UnaryL1Op
                ascendc::AbsL1Op, ascendc::ExpL1Op, ascendc::LnL1Op, ascendc::NotL1Op, ascendc::ReciprocalL1Op,
                ascendc::ReluL1Op, ascendc::RsqrtL1Op, ascendc::SqrtL1Op,
                // UnaryL2Op
                ascendc::AbsL2Op, ascendc::ExpL2Op, ascendc::LnL2Op, ascendc::NotL2Op, ascendc::ReciprocalL2Op,
                ascendc::ReluL2Op, ascendc::RsqrtL2Op, ascendc::SqrtL2Op, ascendc::NegL2Op,
                // VecVcon (Type conversion) operations
                ascendc::CastL0Op, ascendc::CastL1Op, ascendc::CastL2Op, ascendc::CastDeqL0Op, 
                ascendc::CastDeqL1Op, ascendc::CastDeqL2Op, ascendc::SetDeqScaleOp,
                // Vector gatherMask operations
                ascendc::GatherMaskOp,ascendc::GetGatherMaskRemainCountOp,

                // Core
                // GlobalTensor operations
                ascendc::GlobalTensorSubIndexOp,
                ascendc::GlobalTensorBracketOp,
                // LocalTensor operations
                ascendc::LocalTensorV2Op, ascendc::LocalTensorBracketOp,
                ...
                ascendc::TQueBindDequeTensorOp, ascendc::TQueBindDequeTensorInPlaceOp, ascendc::TQueBindEnqueTensorPosOp, 
                ascendc::ToQueBindOp,
...
void addCaseByIndex(TypeSwitchT& typeSwitch, CallbackT&& callback) {
    ...
    typeSwitch.template Case<ElemType>([&callback](auto op){ 
        return callback(op);
    });
}
...
LogicalResult emitOperation(CodeEmitter& emitter, Operation& op, bool trailingSemicolon)
{
    ...
    LogicalResult status = typeSwitch.Default([&](Operation* op) -> LogicalResult{
