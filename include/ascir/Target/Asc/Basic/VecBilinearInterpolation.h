...
#ifndef ASCIR_TARGET_ASC_BASIC_BILINEAR_INTERPOLATION_H
#define ASCIR_TARGET_ASC_BASIC_BILINEAR_INTERPOLATION_H
...
#endif // ASCIR_TARGET_ASC_BASIC_BILINEAR_INTERPOLATION_H
