...
auto printOperation(CodeEmitter &emitter, UnaryL0Op op)
    -> LogicalResultForT<UnaryL0Op, ascendc::AbsL0Op, ascendc::ExpL0Op, ascendc::LnL0Op, ascendc::NotL0Op,
                         ascendc::ReciprocalL0Op, ascendc::ReluL0Op, ascendc::RsqrtL0Op, ascendc::SqrtL0Op>
{
    auto &os = emitter.ostream();
...
auto printOperation(CodeEmitter &emitter, UnaryL1Op op)
    -> LogicalResultForT<UnaryL1Op, ascendc::AbsL1Op, ascendc::ExpL1Op, ascendc::LnL1Op, ascendc::NotL1Op,
                         ascendc::ReciprocalL1Op, ascendc::ReluL1Op, ascendc::RsqrtL1Op, ascendc::SqrtL1Op>
{
    auto &os = emitter.ostream();
...
auto printOperation(CodeEmitter &emitter, UnaryL2Op op)
    -> LogicalResultForT<UnaryL2Op, ascendc::AbsL2Op, ascendc::ExpL2Op, ascendc::LnL2Op, ascendc::NotL2Op,
                         ascendc::ReciprocalL2Op, ascendc::ReluL2Op, ascendc::RsqrtL2Op, ascendc::SqrtL2Op,
                         ascendc::NegL2Op>
{
    auto &os = emitter.ostream();
