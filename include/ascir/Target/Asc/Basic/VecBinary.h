...
auto printOperation(CodeEmitter &emitter, BinaryL2Op op)
    -> LogicalResultForT<BinaryL2Op, ascendc::AddL2Op, ascendc::AddDeqReluL2Op, ascendc::AddReluL2Op,
                         ascendc::AddReluCastL2Op, ascendc::AndL2Op, ascendc::DivL2Op, ascendc::FusedAbsSubL2Op,
                         ascendc::FusedExpSubL2Op, ascendc::FusedMulAddL2Op, ascendc::FusedMulAddReluL2Op,
                         ascendc::MaxL2Op, ascendc::MinL2Op, ascendc::MulL2Op, ascendc::MulAddDstL2Op,
                         ascendc::MulCastL2Op, ascendc::OrL2Op, ascendc::PreluL2Op, ascendc::SubL2Op,
                         ascendc::SubReluL2Op, ascendc::SubReluCastL2Op>
{
    auto &os = emitter.ostream();
    os << ascNamespace << "::" << op.getAPIName();
...
auto printOperation(CodeEmitter &emitter, BinaryTemplateL0Op op)
    -> LogicalResultForT<BinaryTemplateL0Op, ascendc::AddL0Op, ascendc::AddReluL0Op, ascendc::AndL0Op, ascendc::DivL0Op,
                         ascendc::FusedMulAddL0Op, ascendc::FusedMulAddReluL0Op, ascendc::MaxL0Op, ascendc::MinL0Op,
                         ascendc::MulL0Op, ascendc::OrL0Op, ascendc::SubL0Op, ascendc::SubReluL0Op>
{
    auto &os = emitter.ostream();
...
auto printOperation(CodeEmitter &emitter, BinaryTemplateL1Op op)
    -> LogicalResultForT<BinaryTemplateL1Op, ascendc::AddL1Op, ascendc::AddReluL1Op, ascendc::AndL1Op, ascendc::DivL1Op,
                         ascendc::FusedMulAddL1Op, ascendc::FusedMulAddReluL1Op, ascendc::MaxL1Op, ascendc::MinL1Op,
                         ascendc::MulL1Op, ascendc::OrL1Op, ascendc::SubL1Op, ascendc::SubReluL1Op>
{
    auto &os = emitter.ostream();
    auto maskName = printMask(emitter, op);
    FAIL_OR(printIsSetMaskTemplate(emitter, op));
...
auto printOperation(CodeEmitter &emitter, BinaryCastL0Op op)
    -> LogicalResultForT<BinaryCastL0Op, ascendc::AddDeqReluL0Op, ascendc::AddReluCastL0Op, ascendc::SubReluCastL0Op,
...
auto printOperation(CodeEmitter &emitter, BinaryCastL1Op op)
    -> LogicalResultForT<BinaryCastL1Op, ascendc::AddDeqReluL1Op, ascendc::AddReluCastL1Op, ascendc::SubReluCastL1Op,
                         ascendc::MulAddDstL1Op>
{
    auto &os = emitter.ostream();
    auto maskName = printMask(emitter, op);
    FAIL_OR(printIsSetMaskCastTemplate(emitter, op));
...
auto printOperation(CodeEmitter &emitter, BinaryL3Op op)
    -> LogicalResultForT<BinaryL3Op, ascendc::AddL3Op, ascendc::DivL3Op, ascendc::MulL3Op, ascendc::SubL3Op>
{
    auto &os = emitter.ostream();
    os << emitter.getOrCreateName(op.getDst()) << " = " << emitter.getOrCreateName(op.getSrc0()) << "."
