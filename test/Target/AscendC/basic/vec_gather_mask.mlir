...
// CHECK-NEXT:   AscendC::GatherMask<float, AscendC::defaultGatherMaskMode>(v1, v2, c1_i8, v4, v5, v6, *v8);
// CHECK-NEXT:   return;
// CHECK-NEXT: }
func.func @emit_gather_mask(%dst: !ascendc.local_tensor<1024xf32>, %src0: !ascendc.local_tensor<1024xf32>,
  ...
  %rsvd_cnt_memref = memref.alloca() : memref<1xi64>
  ascendc.gather_mask %dst, %src0, %pattern_tensor, %reduce_mode, %mask, %params, %rsvd_cnt_memref {gatherMaskMode = 0 : i32} :
    !ascendc.local_tensor<1024xf32>, !ascendc.local_tensor<1024xf32>, !ascendc.local_tensor<32xui32>, i1, ui32, !ascendc.gather_mask_params, memref<1xi64>
  
  %pattern_const = arith.constant 1 : i8
  ascendc.gather_mask %dst, %src0, %pattern_const, %reduce_mode, %mask, %params, %rsvd_cnt_memref {gatherMaskMode = 0 : i32} :
    !ascendc.local_tensor<1024xf32>, !ascendc.local_tensor<1024xf32>, i8, i1, ui32, !ascendc.gather_mask_params, memref<1xi64>
  return
}
