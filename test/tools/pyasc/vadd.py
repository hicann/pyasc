...
# CHECK-NEXT: module {
# CHECK-NEXT:   func.func @copy_out(%arg0: i32 loc("i"(#loc1)), %arg1: !ascendc.global_tensor<*xf32> loc("z_gm"(#loc1)), %arg2: !ascendc.queue<vecout, 1> loc("out_queue_z"(#loc1))) attributes {ascendc.aicore} {
# CHECK-NEXT:     %0 = ascendc.que_bind.deque_tensor %arg2 : !ascendc.queue<vecout, 1>, !ascendc.local_tensor<*xf32> loc(#loc2)
...
# CHECK-NEXT:     ascendc.que_bind.free_tensor %arg2, %0 : !ascendc.queue<vecout, 1>, !ascendc.local_tensor<*xf32> loc(#loc5)
# CHECK-NEXT:     return loc(#loc5)
# CHECK-NEXT:   } loc(#loc1)
# CHECK-NEXT:   func.func @compute(%arg0: !ascendc.global_tensor<*xf32> loc("z_gm"(#loc6)), %arg1: !ascendc.queue<vecin, 1> loc("in_queue_x"(#loc6)), %arg2: !ascendc.queue<vecin, 1> loc("in_queue_y"(#loc6)), %arg3: !ascendc.queue<vecout, 1> loc("out_queue_z"(#loc6))) attributes {ascendc.aicore} {
# CHECK-NEXT:     %0 = ascendc.que_bind.deque_tensor %arg1 : !ascendc.queue<vecin, 1>, !ascendc.local_tensor<*xf32> loc(#loc7)
# CHECK-NEXT:     %1 = ascendc.que_bind.deque_tensor %arg2 : !ascendc.queue<vecin, 1>, !ascendc.local_tensor<*xf32> loc(#loc8)
# CHECK-NEXT:     %2 = ascendc.que_bind.alloc_tensor %arg3 : !ascendc.queue<vecout, 1>, !ascendc.local_tensor<*xf32> loc(#loc9)
...
# CHECK-NEXT:     ascendc.que_bind.enque_tensor %arg3, %2 : !ascendc.queue<vecout, 1>, !ascendc.local_tensor<*xf32> loc(#loc11)
# CHECK-NEXT:     ascendc.que_bind.free_tensor %arg1, %0 : !ascendc.queue<vecin, 1>, !ascendc.local_tensor<*xf32> loc(#loc12)
# CHECK-NEXT:     ascendc.que_bind.free_tensor %arg2, %1 : !ascendc.queue<vecin, 1>, !ascendc.local_tensor<*xf32> loc(#loc13)
# CHECK-NEXT:     return loc(#loc13)
# CHECK-NEXT:   } loc(#loc6)
# CHECK-NEXT:   func.func @copy_in(%arg0: i32 loc("i"(#loc14)), %arg1: !ascendc.global_tensor<*xf32> loc("x_gm"(#loc14)), %arg2: !ascendc.global_tensor<*xf32> loc("y_gm"(#loc14)), %arg3: !ascendc.queue<vecin, 1> loc("in_queue_x"(#loc14)), %arg4: !ascendc.queue<vecin, 1> loc("in_queue_y"(#loc14))) attributes {ascendc.aicore} {
# CHECK-NEXT:     %0 = ascendc.que_bind.alloc_tensor %arg3 : !ascendc.queue<vecin, 1>, !ascendc.local_tensor<*xf32> loc(#loc15)
# CHECK-NEXT:     %1 = ascendc.que_bind.alloc_tensor %arg4 : !ascendc.queue<vecin, 1>, !ascendc.local_tensor<*xf32> loc(#loc16)
...
# CHECK-NEXT:     ascendc.que_bind.enque_tensor %arg3, %0 : !ascendc.queue<vecin, 1>, !ascendc.local_tensor<*xf32> loc(#loc21)
# CHECK-NEXT:     ascendc.que_bind.enque_tensor %arg4, %1 : !ascendc.queue<vecin, 1>, !ascendc.local_tensor<*xf32> loc(#loc22)
...
# CHECK-NEXT:     %12 = ascendc.queue : <vecin, 1> loc(#loc30)
# CHECK-NEXT:     %13 = ascendc.queue : <vecin, 1> loc(#loc31)
# CHECK-NEXT:     %14 = ascendc.queue : <vecout, 1> loc(#loc32)
# CHECK-NEXT:     %c1_i32 = arith.constant 1 : i32 loc(#loc33)
# CHECK-NEXT:     %c256_i32 = arith.constant 256 : i32 loc(#loc33)
# CHECK-NEXT:     ascendc.pipe.init_queue %11, %12, %c1_i32, %c256_i32 : !ascendc.queue<vecin, 1>, i32, i32 loc(#loc33)
# CHECK-NEXT:     %c1_i32_0 = arith.constant 1 : i32 loc(#loc34)
# CHECK-NEXT:     %c256_i32_1 = arith.constant 256 : i32 loc(#loc34)
# CHECK-NEXT:     ascendc.pipe.init_queue %11, %13, %c1_i32_0, %c256_i32_1 : !ascendc.queue<vecin, 1>, i32, i32 loc(#loc34)
# CHECK-NEXT:     %c1_i32_2 = arith.constant 1 : i32 loc(#loc35)
# CHECK-NEXT:     %c256_i32_3 = arith.constant 256 : i32 loc(#loc35)
# CHECK-NEXT:     ascendc.pipe.init_queue %11, %14, %c1_i32_2, %c256_i32_3 : !ascendc.queue<vecout, 1>, i32, i32 loc(#loc35)
...
# CHECK-NEXT:       func.call @copy_in(%arg3, %4, %7, %12, %13) : (i32, !ascendc.global_tensor<*xf32>, !ascendc.global_tensor<*xf32>, !ascendc.queue<vecin, 1>, !ascendc.queue<vecin, 1>) -> () loc(#loc)
# CHECK-NEXT:       func.call @compute(%10, %12, %13, %14) : (!ascendc.global_tensor<*xf32>, !ascendc.queue<vecin, 1>, !ascendc.queue<vecin, 1>, !ascendc.queue<vecout, 1>) -> () loc(#loc)
# CHECK-NEXT:       func.call @copy_out(%arg3, %10, %14) : (i32, !ascendc.global_tensor<*xf32>, !ascendc.queue<vecout, 1>) -> () loc(#loc)
